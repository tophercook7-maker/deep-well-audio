  ...
  return (
    <>
      <header
        ref={headerRef}
        className={[
          "z-50 border-b border-line/80 bg-bg/85 shadow-[0_8px_28px_rgba(0,0,0,0.22)] backdrop-blur-md backdrop-saturate-150 max-md:border-line/60 max-md:shadow-[0_4px_22px_rgba(0,0,0,0.2)]",
