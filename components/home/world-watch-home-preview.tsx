    ...
    <>
      {!embedded ? (
        <div className="mb-9 max-w-2xl">
          ...
          <p className="mt-3 max-w-prose text-sm leading-[1.65] text-slate-400 sm:text-base">
            Members see the full set and written digest. Preview below.
          </p>
        </div>
      ) : (
        <div className="mb-6 max-w-2xl">
          <p className="text-sm text-slate-400">Written digest</p>
        </div>
      )}
      ...
      {!embedded ? (
        <div className="mt-9 flex flex-col gap-3 border-t border-line/40 pt-7 sm:flex-row sm:flex-wrap sm:items-center sm:gap-4">
          ...
          <p className="text-xs leading-relaxed text-slate-400">Premium in-app.</p>
        </div>
      ) : null}
    </>
  );
