        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="mt-3 max-w-prose text-sm leading-relaxed text-slate-400">
              A measured read on faith and public life—grounded, calm, for listeners who already love serious Bible teaching. The full edition is
              for <span className="text-slate-300">Premium members</span> here on Deep Well: unhurried, prayerful, not another loud feed.
            </p>
          </div>
        </div>
        <ul className="mt-6 space-y-3 border-t border-line/50 pt-6 text-sm leading-[1.65] text-slate-300/95">
