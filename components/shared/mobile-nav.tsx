            ...
            <div className="fixed inset-0 z-[100] md:hidden" role="dialog" aria-modal="true" aria-label="Site navigation">
              ...
              >
                ...
                <nav className="flex-1 overflow-y-auto px-3 py-4" aria-label="Primary">
                  ...
                  {signedIn ? (
                    <>
                      <p className="mb-2 mt-6 px-2 text-[10px] font-semibold uppercase tracking-[0.2em] text-amber-200/65">
                        Your study
                      </p>
                      <ul className="space-y-1">
                        {ME_NAV.map((item) => {
                  ...
                  <p className="mb-2 mt-6 px-2 text-[10px] font-semibold uppercase tracking-[0.2em] text-slate-500">
                    Listen &amp; library
                  </p>
                  <ul className="space-y-1">
